<template>
  <div id="app">
    ...
    <p>
      日付：
      <input type="date" name="scheduleDate" v-model="scheduleDate" value size="40" />
    </p>
    <p>
      開始時間：
...
export default {
  ...
  methods: {
    ...
    doAddschedule() {
      ...
      params.append(
        "scheduleStartDate",
        this.scheduleDate + space + this.scheduleStartTime + scheduleSeconds
      );
      params.append(
        "scheduleEndDate",
        this.scheduleDate + space + this.scheduleEndTime + scheduleSeconds
      );
